...
@section('content')
    ...
    <div class="panel-body" style="padding: 10px 0px;">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link disabled active" href="#">Waiting</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('module.student.apply')}}" tabindex="-1" aria-disabled="true">All Apply</a>
            </li>
        </ul>
    </div>
...
{{--                            <a href="{{url("/application/$item->id/status")}}" class="btn btn-sm btn-info btn-default hire-audit" @if($item->allocation_status==1) disabled @endif>Hire</a>--}}
                            <button type="button"  class="btn btn-sm btn-info btn-default hire-audit" hire-id="{{$item->id}}" hire-action-status="1" @if($item->allocation_status==1) disabled @endif>Hire</button>
                    </td>
                    @endif
